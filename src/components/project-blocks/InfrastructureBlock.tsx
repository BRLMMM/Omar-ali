        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            >
              ...
              <span className="text-[#6366f1] font-mono text-sm tracking-[0.3em] uppercase">DEPLOYMENT ARCHITECTURE</span>
            </motion.div>
          ...
          <motion.div 
            ...
            className="lg:col-span-6 relative w-full aspect-[4/3] bg-zinc-900/40 rounded-[2rem] border border-[#6366f1]/20 flex flex-col items-center justify-center p-8 shadow-2xl overflow-hidden"
          >
             ...
             <div className="relative w-full max-w-[300px] aspect-square flex items-center justify-center z-10">
                <svg viewBox="0 0 200 200" className="w-full h-full overflow-visible">
                   ...
                   {/* Server Blades Rack */}
                   <rect x="50" y="40" width="100" height="120" rx="4" fill="#050505" stroke="#6366f1" strokeWidth="2" />
                   ...
                   <line x1="65" y1="60" x2="85" y2="60" stroke="#6366f1" strokeWidth="2" strokeLinecap="round" />
                   ...
                   <line x1="65" y1="90" x2="105" y2="90" stroke="#6366f1" strokeWidth="2" strokeLinecap="round" />
                   ...
                   <line x1="65" y1="120" x2="95" y2="120" stroke="#6366f1" strokeWidth="2" strokeLinecap="round" />

                   {/* Uplink Data Stream */}
                   <path d="M 100 0 L 100 40" stroke="rgba(99, 102, 241, 0.5)" strokeWidth="2" strokeDasharray="4 4" />
                   <motion.circle cx="100" cy="0" r="4" fill="#6366f1" animate={{ cy: [0, 40] }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }} />
                   <motion.circle cx="100" cy="0" r="4" fill="#6366f1" animate={{ cy: [0, 40] }} transition={{ duration: 1, repeat: Infinity, ease: "linear", delay: 0.5 }} />
             ...
             <div className="absolute bottom-6 left-0 w-full flex justify-center z-20">
                <span className="px-4 py-2 bg-[#6366f1]/10 backdrop-blur rounded-full text-[#6366f1] font-mono text-[10px] tracking-widest uppercase flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                 {data.tools.map((tool, index) => (
                    <motion.div 
                      ...
                      className="group p-8 rounded-3xl bg-zinc-900/50 border border-[#6366f1]/10 hover:border-[#6366f1]/50 transition-colors duration-300 relative overflow-hidden"
                    >
                       ...
                       <h4 className="text-[#6366f1] font-mono text-lg font-bold mb-3">{tool.name}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
            {data.metrics.map((metric, i) => (
              <motion.div 
                ...
                className="relative flex flex-col justify-between h-56 p-8 rounded-3xl bg-zinc-900 border border-white/5 group hover:border-[#6366f1]/50 overflow-hidden transition-colors"
              >
                  ...
                  <div className="absolute inset-x-0 bottom-0 h-32 opacity-40 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                     ...
                     {i === 1 && (
                       <svg className="w-full h-full" viewBox="0 0 100 50" preserveAspectRatio="xMidYMax meet">
                          <motion.circle cx="50" cy="50" r="40" fill="none" stroke="rgba(99,102,241,0.2)" strokeWidth="1" />
                          <motion.circle cx="50" cy="50" r="40" fill="none" stroke="#6366f1" strokeWidth="2" strokeDasharray="60 200"
                              animate={{ rotate: 360 }} transition={{ duration: 4, repeat: Infinity, ease: "linear" }} style={{ originX: "50px", originY: "50px" }} />
                          <motion.circle cx="50" cy="50" r="25" fill="none" stroke="rgba(99,102,241,0.2)" strokeWidth="1" />
                          <motion.circle cx="50" cy="50" r="25" fill="none" stroke="#6366f1" strokeWidth="2" strokeDasharray="30 100"
                     ...
                     {i === 2 && (
                       <div className="w-full h-full flex items-end justify-between gap-[2px] px-2 pb-2">
                          {[...Array(15)].map((_, j) => (
                            <motion.div 
                              key={j} 
                              className="w-full bg-[#6366f1]/60 rounded-t-sm"
                     ...
                     {i === 3 && (
                        <svg className="w-full h-full" viewBox="0 0 100 50" preserveAspectRatio="none">
                           <path d="M 20 40 L 50 10 L 80 40 L 50 30 Z" fill="none" stroke="rgba(99,102,241,0.3)" strokeWidth="1" />
                           <motion.circle cx="20" cy="40" r="2" fill="#6366f1" className="animate-ping" />
                           <motion.circle cx="50" cy="10" r="3" fill="#6366f1" />
                           <motion.circle cx="80" cy="40" r="2" fill="#6366f1" className="animate-ping" />
                           <motion.circle cx="50" cy="30" r="2" fill="#6366f1" />
                  ...
                  <div className="relative z-10 flex flex-col h-full justify-start">
                    ...
                    <span className="text-[#6366f1] font-mono text-xs tracking-widest uppercase mt-4">
                      {metric.label}
                    </span>
                  </div>
              </motion.div>
